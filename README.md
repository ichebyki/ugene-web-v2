...
Start `com.unipro.boilerplate.springreactboilerplate.SpringReactBoilerplateApplication` in your IDE
...
To run the app
    ...
    java -jar target/spring-react-boilerZplate-0.0.1-SNAPSHOT.jar
